...
class Test_hconf_zk : public :: testing::Test
{
protected:
    virtual void SetUp()
    {
        ...
        zh = zookeeper_init(host, global_watcher, HCONF_ZK_DEFAULT_RECV_TIMEOUT, NULL, NULL, 0);
        zoo_create_or_set(zh, "/hconf", "hconf");
        zoo_create_or_set(zh, "/hconf/__unit_test", "unit test");
    }
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_null_zh)
{
    int ret = 0;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_empty_path)
{
    int ret = 0;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_not_exist_path)
{
    int ret = 0;

    string path = "/hconf/__unit_test/not_exist_path";
    string_vector_t nodes;

    ret = zk_get_chdnodes(zh, path, nodes);
    EXPECT_EQ(HCONF_NODE_NOT_EXIST, ret);
}

// Test for zk_get_chdnodes : path is illegal value
TEST_F(Test_hconf_zk, zk_get_chdnodes_illegal_path)
{
    int ret = 0;
    ...
    ret = zk_get_chdnodes(zh, path, nodes);
    EXPECT_EQ(HCONF_ERR_ZOO_FAILED, ret);
}

// Test for zk_get_chdnodes : zero child
TEST_F(Test_hconf_zk, zk_get_chdnodes_zero_child)
{
    int ret = 0;

    string path = "/hconf/__unit_test/zero_child";
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_10_children)
{
    int ret = 0;

    string path = "/hconf/__unit_test/10_child";
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_100_children)
{
    int ret = 0;

    string path = "/hconf/__unit_test/100_child";
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_null_zh)
{
    int ret = 0;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_empty_path)
{
    int ret = 0;
    string path;
    string_vector_t nodes;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_not_exist_path)
{
    int ret = 0;
    vector<char> status;
    string_vector_t nodes;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_illegal_path)
{
    int ret = 0;
    vector<char> status;
    string_vector_t nodes;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_zero_serv)
{
    int ret = 0;
    string_vector_t nodes;
    string value("zero service");
    string path = "/hconf/__unit_test/zero_service";
    vector<char> status;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_10_servs_all_down)
{
    int ret = 0;
    string_vector_t nodes;
    size_t chd_count = 10;
    ...
    string path = "/hconf/__unit_test/10_servs";
    vector<char> status;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_10_servs_half_down)
{
    int ret = 0;
    string_vector_t nodes;
    size_t chd_count = 10;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_10_servs_half_offline)
{
    int ret = 0;
    string_vector_t nodes;
    size_t chd_count = 10;
...
TEST_F(Test_hconf_zk, zk_get_chdnodes_with_status_10_servs_all_up)
{
    int ret = 0;
    string_vector_t nodes;
    size_t chd_count = 10;
...
TEST_F(Test_hconf_zk, zk_get_node_not_exists)
{
    int ret = 0;
    string path = "/hconf/__unit_test/untest";
    string buf;
...
TEST_F(Test_hconf_zk, zk_get_node_bad_arguments)
{
    int ret = 0;
...
TEST_F(Test_hconf_zk, zk_get_node_exists)
{
    int ret = 0;
    string path = "/hconf/__unit_test/test";
...
TEST_F(Test_hconf_zk, zk_get_node_with_empty_val)
{
    int ret = 0;
    string path("/hconf/__unit_test/nullval");
    string buf;
...
TEST_F(Test_hconf_zk, zk_get_node_with_1k_val)
{
    string buf;
    int ret = 0;
    string path("/hconf/__unit_test/1k");
    string value(1024, 'a');
...
TEST_F(Test_hconf_zk, zk_get_node_with_10k_val)
{
    string buf;
    int ret = 0;
    string path("/hconf/__unit_test/10k");
...
TEST_F(Test_hconf_zk, zk_get_node_with_100k_val)
{
    string buf;
    int ret = 0;
    string path("/hconf/__unit_test/100k");
    string value(10240, 'a');
...
TEST_F(Test_hconf_zk, zk_get_node_with_1m_val)
{
    string buf;
    int ret = 0;
    string path("/hconf/__unit_test/1m");
...
TEST_F(Test_hconf_zk, zk_create_node_parent_not_exists)
{
    int ret = 0;
    string path = "/hconf/111/tst_create_no";
    string value("hello");
...
TEST_F(Test_hconf_zk, zk_create_node_not_exists)
{
    int ret = 0;
    string path = "/hconf/__unit_test/tst_create_no";
    string buf;
    string value("hello");
...
TEST_F(Test_hconf_zk, zk_create_node_exists)
{
    int ret = 0;
    string path = "/hconf/__unit_test/tst_create";
    string value = "hello good";

    ret = zk_create_node(zh, path, value, 0);

    EXPECT_EQ(HCONF_NODE_EXIST, ret);
}

// Test for zk_create_node: node val = empty
TEST_F(Test_hconf_zk, zk_create_node_with_empty_val)
{
    int ret = 0;
    string path("/hconf/__unit_test/tst_create_nullval");
    string buf;
...
TEST_F(Test_hconf_zk, zk_create_node_with_1k_val)
{
    string buf;
    int ret = 0;
    string path("/hconf/__unit_test/test_create_1k");
    string value(1024, 'a');
...
TEST_F(Test_hconf_zk, zk_register_ephemeral_null_zh)
{
    int ret = 0;
    string path = "/hconf/__unit_test/test";
...
TEST_F(Test_hconf_zk, zk_register_ephemeral_empty_path)
{
    int ret = 0;
    const char* val = "hello";
    string path;
...
TEST_F(Test_hconf_zk, zk_register_ephemeral_empty_value)
{
    int ret = 0;
    string path = "/hconf/test";
    string value;
...
TEST_F(Test_hconf_zk, zk_register_ephemeral_invalid_path)
{
    int ret = 0;
    string path = "hconf/test";
    const char* val = "hello";
...
// Test for zk_register_ephemeral: path="/hconf"
TEST_F(Test_hconf_zk, zk_register_ephemeral_path_with_one_delim)
{
    int ret = 0;
    string path = "/hconf/__hconf_register_hosts";
    const char* val = "hello";
    string buf;
    char hostname[256] = {0};
    string path_buf;
...
// Test for hconf_init_zoo_log: log_dir empty
TEST_F(Test_hconf_zk, hconf_init_zoo_log_empty_log_dir)
{
    string log_dir;
    string zoo_log;

    int ret = hconf_init_zoo_log(log_dir, zoo_log);
    EXPECT_EQ(HCONF_ERR_PARAM, ret);
}

// Test for hconf_init_zoo_log: zoo_log empty
TEST_F(Test_hconf_zk, hconf_init_zoo_log_empty_zoo_log)
{
    string log_dir(".");
    string zoo_log;
...
// Test for hconf_init_zoo_log: log dir not exist
TEST_F(Test_hconf_zk, hconf_init_zoo_log_unexist_log_dir)
{
    string log_dir("/unexist_log_dir");
    string zoo_log("zoo_err.log");

    int ret = hconf_init_zoo_log(log_dir, zoo_log);
    EXPECT_EQ(HCONF_ERR_FAILED_OPEN_FILE, ret);
}

// Test for hconf_init_zoo_log: zoo log not exist
TEST_F(Test_hconf_zk, hconf_init_zoo_log_unexist_zoo_log)
{
    string log_dir("./logs");
    string zoo_log("zoo_err.log");
...
// Test for hconf_init_zoo_log: zoo log exist
TEST_F(Test_hconf_zk, hconf_init_zoo_log_exist_zoo_log)
{
    string log_dir("./logs");
    string zoo_log("zoo_err.log");
