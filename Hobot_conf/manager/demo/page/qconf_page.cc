...
fprintf(cgiOut, "<title>HConf - Master</title>");
...
fprintf(cgiOut, "<h1>");
fprintf(cgiOut, "HConf Manager");
fprintf(cgiOut, "</h1>");
fprintf(cgiOut, "<p>");
fprintf(cgiOut, "HConf Management Interface.");
fprintf(cgiOut, "</p>");
fprintf(cgiOut, "</div>");
fprintf(cgiOut, "<h2>");
fprintf(cgiOut, "HConf Node Infomation");
fprintf(cgiOut, "</h2>");
fprintf(cgiOut, "<hr/>");
...
fprintf(cgiOut, "More Infomation <a href=\"https://github.com/Qihoo360/HConf\" target=\"_blank\" title=\"github\">Github</a>  <a href=\"https://github.com/Qihoo360/HConf/wiki\" title=\"wiki\" target=\"_blank\">wiki</a>");
fprintf(cgiOut, "</li>");
fprintf(cgiOut, "</ul>");
fprintf(cgiOut, "</div>");
fprintf(cgiOut, "</div>");
